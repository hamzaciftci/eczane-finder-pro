...
import { Code, Globe, Cross, Phone, ExternalLink } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { motion } from "framer-motion";

const BASE_URL = "https://nobetci-eczane-tau.vercel.app";
          ...
          >
            ...
            <div className="overflow-hidden rounded-2xl border border-border shadow-card">
              ...
              <div className="flex items-center justify-between bg-primary px-5 py-3">
                ...
                <span className="text-[10px] text-primary-foreground/70">powered by Nöbetçi Eczane</span>
              </div>
              ...
              <div className="divide-y divide-border bg-card">
                {[
                  ...
                  <div key={item.name} className="flex items-center justify-between px-5 py-3">
                    ...
                    <a href={`tel:${item.phone}`} className="flex items-center gap-1 text-xs text-primary hover:underline">
              ...
              <div className="border-t border-border bg-muted/50 px-5 py-2.5 text-center">
                <a href={`${BASE_URL}/nobetci-eczane/${selectedCity}`} target="_blank" rel="noopener" className="inline-flex items-center gap-1 text-xs font-medium text-primary hover:underline">
                  Detayları görüntüle
