...
import { Cross, Clock, MapPin, Shield, Search, ArrowRight, ChevronRight } from "lucide-react";
...
const steps = [
  ...
  { num: "3", title: "Yol Tarifini Aç", desc: "Google Maps ile yol tarifini al ve git." },
];
    ...
    <MainLayout>
      ...
      <section className="relative overflow-hidden bg-surface py-20 md:py-28">
        ...
        <div className="container relative flex flex-col items-center text-center">
          ...
          >
            <span className="text-xs text-muted-foreground mr-1">Popüler:</span>
